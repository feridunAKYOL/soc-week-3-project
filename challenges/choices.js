...
function choicesHandler() {
	...
	let text = prompt('enter your text please!');
	let option = prompt(
		"enter 'small' for lowercase\n enter 'big' for Uppercase \n enter 'slim' for unnecessary blank"
	);

	// execute core logic
	let ResultText = choices(text, option);
